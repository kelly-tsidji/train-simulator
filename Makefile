...
MetroSim: main.o MetroSim.o PassengerQueue.o Passenger.o
	${CXX} -o MetroSim main.o MetroSim.o PassengerQueue.o Passenger.o
...
unit_test.o: unit_test.cpp PassengerQueue.h Passenger.h
...
unit_test: unit_test.o PassengerQueue.o Passenger.o
	${CXX} -o unit_test unit_test.o PassengerQueue.o Passenger.o
